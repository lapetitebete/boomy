...
export interface CardProfessionalBoxProps {
  className?: string;
  professional: ProfessionalType;
  index?: number;
}

const CardProfessionalBox: FC<CardProfessionalBoxProps> = ({
  className = "",
  professional,
  index,
}) => {
  const { displayName, href = "/", avatar, starRating } = professional;
  return (
    <Link
      to={`${href}/${professional.id}`}
...
export default CardProfessionalBox;
