...
import TechnicianSearchForm from "./(technician-search-form)/TechnicianSearchForm";
    ...
    return (
      ...
      >
        ...
        <div className="ml-3 flex-1 text-left overflow-hidden">
          <span className="block font-medium text-sm">Profession?</span>
          <div className="block mt-0.5 text-xs font-light text-neutral-500 dark:text-neutral-400 ">
            <span className="line-clamp-1">
              Qui vous souhaitez • Où vous souhaitez
            </span>
          </div>
        </div>
