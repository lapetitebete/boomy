...
import AVAILABLE_LOCATIONS from "utils/locations";
...
const LocationInput: FC<Props> = ({
  ...
  //   dispatch(searchQueryActions.updateLocation(value));
    ...
    <div className={`${className}`} ref={containerRef}>
      <div className="p-5">
        ...
        <div className="mt-7">
          {value
            ? renderSearchValues({
                heading: filteredLocations.length > 0 ? "Villes" : "",
                items: filteredLocations,
              })
            : renderSearchValues({
                heading: "Les plus populaires",
